            ...
            try {
                ...
                switch ($Sub_Command) {
                    ...
                    case 'onbuild':
                        ...
                        $app_ver = isset($data->appver) ? $data->appver : null;
                        if ($app_path == null) {
                        ...
                        $queryapps = 'INSERT INTO custom_app (build_id, user_id, app_package, app_path,appname,app_ico, build_date, app_ver, build_state) 
                        VALUES (NULL, :userid, :appid, :apppath , :apname , :apico , :nowdate , :apver, "onbuild")';
                        $params = array(':userid' => $user_id, ':appid' => $app_id, ':apppath' => $app_path ,':apname' => $app_name, ':apico' => $app_ico, ':nowdate' => $currentDate, ':apver' => $app_ver);
