...
//this to load phones contacts from DB to panel
        ...
        try {
            ...
            if ($result) {
                ...
                try {
                    ...
                    $query = "SELECT cont_id,cont_address,cont_name,cont_via,og_id FROM contacts WHERE phone_id = :phoneId";
                    ...
                    if ($result2 ) {
                        ...
                        $queryremove = "DELETE From contacts WHERE user_id = :uuid or phone_id = :phoneId";
